app.controller('AtendimentosConsultaCtrl', function($rootScope, $scope, $routeParams, $stateParams, $state, $filter, $window, Api) {
	...
	if($state.current.name == 'atendimentos-consulta-lista'){
		$scope.lista({});
	}
});
